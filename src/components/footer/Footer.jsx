                    ...
                    <div className="footer-col">
  	 			        <h4>Follow us</h4>
  	 			             <div className="social-links">
  	 				            ...
  	 				            <p><a href="https://www.instagram.com/mycin.in/"><i className="ri-instagram-fill"></i></a>Instagram</p>
  	 				            <p><a href="https://www.linkedin.com/company/mycin-in/"><i className="ri-linkedin-box-fill"></i></a>Linkedin</p>
  	 			                </div>
  	 		        </div>
